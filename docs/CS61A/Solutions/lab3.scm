CS 61A	 	Laboratory Solutions	Lab 3
...
2.  build type-checking into function
...
3.  How to reverse the order in which coins are tried?
...
4.  Explore the efficiency.  Here is what happens with (cc 5 2) in the
...
5.  Modify CC to take a sentence of denominations.
